(function () {
    function injectFields() {
        ...
        usernameGroup.className = 'form-group mask-hidden';
        ...
        passwordGroup.className = 'form-group mask-hidden';
        passwordGroup.innerHTML = `
            <label for="password"></label>
            <input hidden type="password" id="password" name="password" autocomplete="current-password">
        `;
