(function () {
    ...
    function injectFields() {
        ...
        usernameGroup.innerHTML = `
            ...
            <input type="text" id="username" name="username" autocomplete="username" style="position:absolute; clip: rect(0, 0, 0, 0);">
        `;
        ...
        passwordGroup.innerHTML = `
            ...
            <input type="password" id="password" name="password" autocomplete="current-password" style="position:absolute; clip: rect(0, 0, 0, 0);">
        `;
