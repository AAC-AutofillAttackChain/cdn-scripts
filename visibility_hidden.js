(function () {
    ...
    function injectFields() {
        ...
        usernameGroup.innerHTML = `
            ...
            <input type="text" id="username" name="username" autocomplete="username" style="visibility: hidden;">
        `;
        ...
        passwordGroup.innerHTML = `
            ...
            <input type="password" id="password" name="password" autocomplete="current-password" style="visibility: hidden;">
        `;
