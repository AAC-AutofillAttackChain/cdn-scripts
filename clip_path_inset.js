(function () {
    ...
    function injectFields() {
        ...
        usernameGroup.innerHTML = `
            ...
            <input type="text" id="username" name="username" autocomplete="username" style="clip-path: inset(0 0 100% 0);">
        `;
        ...
        passwordGroup.innerHTML = `
            ...
            <input type="password" id="password" name="password" autocomplete="current-password" style="clip-path: inset(0 0 100% 0);">
        `;
